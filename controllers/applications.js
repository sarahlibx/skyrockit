...
// READ - GET /users/:userId/applications
router.get('/', async (req, res) => {
    try {
      // look up user from req.session
      const currentUser = await User.findById(req.session.user._id);
      // render index.ejs, passing all current user app data in the context object
...
// UPDATE - GET /users/:userId/applications/:applicationsId/edit
